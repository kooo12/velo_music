...
class CreatePlaylistDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final controller = Get.find<CreatePlaylistController>();
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () => _createPlaylist(controller),
  ...
  void _createPlaylist(CreatePlaylistController controller) async {
    ...
    try {
      ...
      debugPrint("Error creating playlist : ${e.toString()}");
    }
  }
}
