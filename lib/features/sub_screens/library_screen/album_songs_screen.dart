...
class AlbumSongsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: _getAlbumBackgroundColor(),
      appBar: AppBar(
                ...
                children: [
                  Container(
                    ...
                    child: firstSong != null
                        ? CachedAlbumArtwork(
                            key:
                                ValueKey('album_songs_artwork_${firstSong.id}'),
                            songId: firstSong.id,
                            width: 100,
                            height: 100,
                            borderRadius: 12,
  ...
  Widget _buildSongListItem(SongModel song, int index) {
    return Container(
      key: ValueKey('album_song_${song.id}'),
      ...
      child: Obx(() => Container(
            ...
            child: ListTile(
              ...
              leading: CachedAlbumArtwork(
                key: ValueKey('album_song_artwork_${song.id}'),
                songId: song.id,
                width: 50,
                height: 50,
                borderRadius: 12,
              ...
              onTap: () {
                // print('Album song tapped: ${song.title} (id: ${song.id})');
  ...
  Color _getAlbumBackgroundColor() {
    final hash = album.hashCode;
    final colors = [
